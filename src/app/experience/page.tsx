...
const NATIVE_DATA: Record<NativeLanguage, {
    ...
    cs: { grammarTerms: ["S+V+O", "Předpřítomný čas", "Vztažné zájmeno", "Infinitiv", "Trpný rod", "Konjunktiv", "Příčestí", "Modální slovesa", "Tranzitivní", "Vedlejší věta podmětná"], rejection: ["Stop learning", "language for the", "sake of grammar."], subRejection: "Nenaučili jsme se mluvit pomocí pravidel a učebnic.", babyWord: "Mámo, mlíko!", babySub: "Když jsi řekl svá první slova, nepotřeboval jsi učebnici gramatiky.", patternPhrases: [{ text: "I want to eat", highlight: "want to", meaning: "chci jíst" }, { text: "I want to go", highlight: "want to", meaning: "chci jít" }, { text: "I want to play", highlight: "want to", meaning: "chci si hrát" }], patternTitle: "Vzorce a kontext. Tak se mozek učí přirozeně.", aiCorrection: { original: "I goes to school", fix: "I go to school", expl: "V 1. osobě se 's' nepoužívá" }, ctaTitle: "The Native Way", ctaSub: "Jazyková platforma nové generace s nativní AI podporující 9 jazyků." },
};
