...
export type UsageType =
    ...
    | 'chat' | 'expression' | 'vocab' | 'grammar' | 'extension' | 'script';
...
const PLAN_LIMITS: Record<string, Record<UsageType, number>> = {
    free: {
        ...
        chat: 3, expression: 3, vocab: 1, grammar: 1, extension: 5, script: 1
    },
    standard: {
        audio: 30, explorer: 30, correction: 10, extraction: 10, explanation: 30, etymology: 15,
        chat: 20, expression: 15, vocab: 10, grammar: 10, extension: 30, script: 10
    },
    pro: {
        audio: 100, explorer: 100, correction: 30, extraction: 30, explanation: 100, etymology: 50,
        chat: 50, expression: 50, vocab: 30, grammar: 30, extension: 100, script: 30
    }
};
